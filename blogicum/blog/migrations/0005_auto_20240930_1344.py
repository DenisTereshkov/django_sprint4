# Generated by Django 3.2.16 on 2024-09-30 10:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='post',
            options={'default_related_name': 'posts', 'ordering': ('-pub_date', 'author'), 'verbose_name': 'публикация', 'verbose_name_plural': 'Публикации'},
        ),
        ...
        migrations.AlterField(
            model_name='post',
            name='image',
            field=models.ImageField(blank=True, upload_to='blog_images', verbose_name='Фото публикации'),
        ),
        migrations.AlterField(
            model_name='post',
            name='location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comments', to='blog.post', verbose_name='Комментируемый пост')),
            ],
            options={
